# proj-dining-caching-proxy

A caching proxy for the UCSB Dining API calls made by
[proj-dining](https://github.com/ucsb-cs156/proj-dining). See
[docs/design/OVERALL-DESIGN.md](docs/design/OVERALL-DESIGN.md) for the full
design and Q&A.
...
See [`docs/oauth.md`](docs/oauth.md) for full setup instructions, and
[`docs/dokku.md`](docs/dokku.md) for Dokku deployment.

MongoDB is embedded automatically for local development and tests — no
separate install needed. See [`docs/mongodb.md`](docs/mongodb.md) for details,
including Dokku setup.
...
The integration tests are in `src/test/java/edu/ucsb/cs156/diningcachingproxy/web/`:

| Test class | What it verifies |
|---|---|
| `OauthWebIT` | User can log in and log out via mock OAuth |
| `SwaggerWebIT` | The Swagger UI page loads successfully |
