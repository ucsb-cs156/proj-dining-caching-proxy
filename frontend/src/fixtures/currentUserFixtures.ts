...
export const apiCurrentUserFixtures = {
  ...
  hostManagerUser: {
    ...
    roles: [{ authority: "ROLE_USER" }, { authority: "ROLE_HOSTMANAGER" }],
  },
...
export const currentUserFixtures = {
  ...
  adminUser: {
    ...
    root: {
      ...
      rolesList: ["ROLE_USER", "ROLE_ADMIN", "ROLE_HOSTMANAGER"],
    },
  },
  hostManagerUser: {
    loggedIn: true as const,
    root: {
      ...apiCurrentUserFixtures.hostManagerUser,
      rolesList: ["ROLE_USER", "ROLE_HOSTMANAGER"],
    },
  },
