...
import edu.ucsb.cs156.diningcachingproxy.services.SystemInfoService;
...
public class SystemInfoControllerTests extends ControllerTestCase {
  ...
  @MockitoBean edu.ucsb.cs156.diningcachingproxy.repository.UserRepository userRepository;
  ...
  public void systemInfo__admin_logged_in() throws Exception {
    ...
    edu.ucsb.cs156.diningcachingproxy.model.SystemInfo systemInfo =
        SystemInfo.builder()
