...
import edu.ucsb.cs156.diningcachingproxy.model.SystemInfo;
...
public class SystemInfoServiceImplTests {
  ...
  public void testGetSystemInfo_whenGitPropertiesIsNull_returnsUnknown() {
    ...
    ReflectionTestUtils.setField(
        service, "sourceRepo", "https://github.com/ucsb-cs156/proj-dining-caching-proxy");
    ...
    assertEquals(
        "https://github.com/ucsb-cs156/proj-dining-caching-proxy/commit/unknown",
        systemInfo.getGithubUrl());
  }
  ...
  public void testGetSystemInfo_whenGitPropertiesIsPresent_returnsGitInfo() {
    ...
    assertEquals(
        "https://github.com/ucsb-cs156/proj-dining-caching-proxy/commit/abc1234",
        systemInfo.getGithubUrl());
  }
}
